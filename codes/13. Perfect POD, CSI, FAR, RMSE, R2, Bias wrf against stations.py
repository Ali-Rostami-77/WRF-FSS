# This code calculates the traditional validation for precipitation. WRF against synoptic stations.
# The calculated metrics are: RMSE, BIAS, R, R2, MAE, POD, FAR, CDI, and generating Performance Diagram and Scatter Plot
...
# Configuration
WRF_FILE = "Path to WRF file"  
STATION_FILE = "Path to stations"
OUTPUT_DIR = "Path of saving the results"
